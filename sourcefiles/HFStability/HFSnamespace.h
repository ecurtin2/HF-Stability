...
extern double mvec_test();
extern void   calc_energy_wrap(bool);
extern void   calc_exc_energy();
extern arma::uword get_k_to_idx(double[]);
extern void get_vir_states_inv();
...
extern double get_1B(arma::uword, arma::uword);
extern double get_3B(arma::uword, arma::uword);
extern double get_1A(arma::uword, arma::uword);
extern double get_3A(arma::uword, arma::uword);
extern double get_3H(arma::uword, arma::uword);
extern void to_first_BZ(arma::vec&);
extern void get_params();
extern void get_inv_exc_map();
extern void get_vir_N_to_1_map();
