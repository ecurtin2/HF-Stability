...
\begin{frame}[fragile]{Levels of Hartree-Fock Theory}
	\begin{center}
		\begin{tabular}{ | c | c | c | c |}
			\hline
			 Method & Spinorbital & DoF & Eigenfunction of\\ 
			\hline 
...
\begin{frame}[fragile]{Restricted Minimization}
	\begin{itemize}
		...
		\begin{itemize}
			\item<2-> \emph{Within the constrained space}
		\end{itemize}
	\end{itemize}
	\begin{center}
...
\begin{frame}[fragile]{Restricted Minimization}
	\includegraphics[width=0.5\linewidth, trim={7cm, 2cm, 7cm, 3cm}, clip]{../images/const_opt_globalmin.jpeg}
\end{frame}

\begin{frame}[fragile]{Restricted Minimization}
	\includegraphics[width=0.5\linewidth, trim={7cm, 2cm, 7cm, 3cm}, clip]{../images/const_opt_saddle.jpeg}
\end{frame}

\begin{frame}[fragile]{Restricted Minimization}
	\includegraphics[width=0.5\linewidth, trim={7cm, 2cm, 7cm, 3cm}, clip]{../images/const_opt_nonstationary.jpeg}
\end{frame}
