...
\begin{frame}{Restricted Minimization}
	\begin{columns}[c] % align columns
		...
		\begin{column}{0.48\textwidth}
		    \begin{overprint}
			    \onslide<1>\includegraphics[width=0.9\linewidth, trim={7cm, 2cm, 7cm, 3cm}, 
			    clip]{../../images/const_opt_globalmin.jpeg}
				\onslide<2>\includegraphics[width=0.9\linewidth, trim={7cm, 1cm, 7cm, 1cm}, 
				clip]{../../images/const_opt_saddle.jpeg}
				\onslide<3>\includegraphics[width=0.9\linewidth, trim={7cm, 2cm, 7cm, 3cm}, 
...
\begin{frame}{Hartree-Fock Stability Conditions}
	\begin{itemize}
		\item[]{Doing this for all cases yields} \\~\\
		\item[]{
...
\begin{frame}{Convergence Properties}
	\begin{itemize}[<+->]
		...
		\end{itemize}
		\item{They can \alert{converge to an eigenvalue other than the target} if:}
		\begin{itemize}
...
\begin{frame}{Dependence on r${}_s$}
	Crossover from stable to unstable in 2D agrees with previous results.
...
\begin{frame}{Dependence on r${}_s$}
\centering
	3D data implies some stability at high density 
	\includegraphics[width=.65\linewidth]{../../images/3dstab.pdf}
\end{frame}
...
\begin{frame}{Dependence on r${}_s$}
  \centering
	Preliminary data for 1D shows some stability 
	\includegraphics[width=.65\linewidth]{../../images/1dstab.pdf}
\end{frame}
